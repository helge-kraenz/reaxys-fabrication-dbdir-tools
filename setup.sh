...
# DBDIRTOOLS                                               #
#                                                          #
# The base directory of the dbdir tools directory.         #
############################################################
export DBDIRTOOLS=$PWD
...
# else.                                                    #
############################################################
alias sdbdir='(cd $DBDIRTOOLS ; create-archive -z s3://nameservice/releases/dbdir-tools MANIFEST-dbdir-tools  MANIFEST-dbdir-tools-test)'
alias ldbdir='aws s3 ls s3://nameservice/releases/dbdir-tools/| grep "PRE" | tail -1 | awk "{print \$2}"'
